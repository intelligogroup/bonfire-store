(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@intelligo.ai/bonfire'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@intelligo.ai/bonfire-store', ['exports', '@angular/core', '@intelligo.ai/bonfire', 'rxjs/operators'], factory) :
    (global = global || self, factory((global.intelligo = global.intelligo || {}, global.intelligo.ai = global.intelligo.ai || {}, global.intelligo.ai['bonfire-store'] = {}), global.ng.core, global.bonfire, global.rxjs.operators));
}(this, (function (exports, core, bonfire, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    (function (BonfireStore) {
        ...
        BonfireStore.BONFIRE_CONFIG = new core.InjectionToken('BONFIRE_CONFIG');
        /**
         * @template T
         */
        var Store = /** @class */ (function () {
            ...
            function (key, callback) {
                ...
                return this.store$
                    .asObservable()
                    .pipe(operators.map(mapCallback), operators.tap(callback || ((/**
                 * @param {?} value
                 * @return {?}
                 */
                function (value) { }))));
    ...
    var BonfireStoreService = /** @class */ (function (_super) {
        ...
        function (initialValue) {
            ...
            this.subStores.push(new exports.ɵa.Store(initialValue, storeKey));
        ...
        BonfireStoreService.ctorParameters = function () { return [
            { type: undefined, decorators: [{ type: core.Inject, args: [exports.ɵa.BONFIRE_CONFIG,] }] }
        ]; };
        /** @nocollapse */ BonfireStoreService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function BonfireStoreService_Factory() { return new BonfireStoreService(core.ɵɵinject(exports.ɵa.BONFIRE_CONFIG)); }, token: BonfireStoreService, providedIn: "root" });
        __decorate([
            bonfire.WithObservable(),
    ...
    var BonfireStoreModule = /** @class */ (function () {
        ...
        function (useValue) {
            ...
            return {
                ...
                providers: [
                    { provide: exports.ɵa.BONFIRE_CONFIG, useValue: useValue }
                ],
            };
        };
        ...
        function (target, key) {
            ...
            function (isGet) {
                ...
                function (newVal) {
                     ...
                     * @return {?}
                     */
                    function (value) { return value instanceof exports.ɵa.Store &&
    ...
    exports.BonfireStore = exports.ɵa;
    exports.BonfireStoreComponent = BonfireStoreComponent;
    exports.BonfireStoreModule = BonfireStoreModule;
    exports.BonfireStoreService = BonfireStoreService;
    exports.FromLocalStore = FromLocalStore;
    exports.FromStore = FromStore;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=intelligo.ai-bonfire-store.umd.js.map
